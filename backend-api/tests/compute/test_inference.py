...
from mimeme.compute.inference import _to_numpy
...
def test_half_precision_features_become_float32() -> None:
...
def test_model_output_fields_are_cast_as_well() -> None:
    for kind, field in (("image", "image_embeds"), ("text", "text_embeds")):
        ...
        array = _to_numpy(output, kind=kind)  # type: ignore[arg-type]
