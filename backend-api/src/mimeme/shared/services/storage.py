...
def get_media_s3_config(app_settings: Settings = settings) -> S3Config:
    return S3Config(
        endpoint_url=app_settings.media.s3_endpoint_url,
        region=app_settings.media.s3_region,
        access_key=app_settings.media.s3_access_key_id,
        secret_key=app_settings.media.s3_secret_access_key.get_secret_value(),
        bucket=app_settings.media.s3_bucket,
        force_path_style=app_settings.media.s3_force_path_style,
    )


def get_artifact_s3_config(app_settings: Settings = settings) -> S3Config:
    return S3Config(
        endpoint_url=app_settings.artifacts.s3_endpoint_url,
        region=app_settings.artifacts.s3_region,
        access_key=app_settings.artifacts.s3_access_key_id,
        secret_key=app_settings.artifacts.s3_secret_access_key.get_secret_value(),
        bucket=app_settings.artifacts.s3_bucket,
        force_path_style=app_settings.artifacts.s3_force_path_style,
    )
