...
class ModalGpuBackend:
    ...
    def __init__(self) -> None:
        self._vision_cls = modal.Cls.from_name(settings.compute.modal_app_name, "VisionService")  # type: ignore[assignment]
        self._embedding_cls = modal.Cls.from_name(
            settings.compute.modal_app_name, "EmbeddingService"
