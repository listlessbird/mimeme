...
class StorageService:
        ...
        try:
            ...
            if error_code in ("404", "NoSuchBucket"):
                try:
                    ...
                    log.error("bucket_create_failed", bucket=self.bucket, error=str(create_err))
                    raise
            else:
                raise
    ...
    def build_embedding_key(self, sha256: str, model_name: str, dataset: str | None) -> str:
        ...
        return f"{self.EMBEDDINGS_PREFIX}/{model_slug}/{source}/{sha256}.npy"
    ...
    def upload_file(self, local_path: Path, key: str, content_type: str | None = None) -> str:
        ...
        log.debug("file_uploaded", key=key, etag=etag)
        return etag or ""
