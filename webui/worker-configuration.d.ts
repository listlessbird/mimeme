/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a9eb68044314e0b5b1d395c3c4b6236)
// Runtime types generated with workerd@1.20260205.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GIF_ANNOTATION_BUCKET: R2Bucket;
		GIF_ANNOTATION_DB: D1Database;
		GIF_ANNOTATION_PUBLIC_BASE_URL: "https://pub-8e70169e442a48869877cd51c44abc2f.r2.dev";
		API_BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, "GIF_ANNOTATION_PUBLIC_BASE_URL" | "API_BASE_URL" | "API_KEY_READONLY">
	> {}
}
